  ...
  return new Promise((resolve) => {
    ...
    video.mv(pathMV + "." + mime, async (error) => {
      if (error) {
        ...
        resolve(
          "/uploads/" + folder_name + "/" + id + "video/" + "0" + "-" + timePath
        );
        ...
        var result480 = await videoUploadFFMPEG(
          pathMV + "-720.mp4",
          "mp4",
          "480",
          pathMV
        );
        var result360 = await videoUploadFFMPEG(
          pathMV + "-480.mp4",
          "mp4",
          "360",
          pathMV
        );
        var result240 = await videoUploadFFMPEG(
          pathMV + "-360.mp4",
          "mp4",
          "240",
          pathMV
        );
        var result144 = await videoUploadFFMPEG(
          pathMV + "-240.mp4",
          "mp4",
          "144",
          pathMV
...
export { videUploadMV, DeleteFolder };
